...
namespace Hunter
{
    public class PlayerWeaponOnGround : MonoBehaviour
    {
        ...
        public void Watch()
        {
            ...
            e.AddListener(() =>
            {
                ...
                LevelController.instance.AddWeapon(weaponType);
        ...
        private void LateUpdate()
        {
            ...
            {
                button.transform.LookAt(new Vector3(transform.position.x, UIInGame.instance.virtualCam.cam.transform.position.y, UIInGame.instance.virtualCam.cam.transform.position.z));
